                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <Badge variant="success" className="text-[10px] font-semibold uppercase tracking-widest">{seller.status}</Badge>
                        </div>
                ...
                {[
                    ...
                    <Card key={i} className="p-6 border-none shadow-xl ring-1 ring-slate-100 bg-white group hover:ring-primary/20 transition-all">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest">{stat.sub}</span>
                        </div>
                        <h4 className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest leading-none mb-1">{stat.label}</h4>
                    ...
                    <div className="flex items-center gap-2 p-1 bg-slate-100/50 backdrop-blur-sm rounded-2xl w-fit">
                        {[
                            ...
                            <button
                                ...
                                className={cn(
                                    "px-5 py-2.5 rounded-xl text-xs font-semibold uppercase tracking-widest transition-all flex items-center gap-2",
                                    activeTab === tab.id
                    ...
                    <Card className="border-none shadow-xl ring-1 ring-slate-100 bg-white rounded-xl overflow-hidden min-h-[500px]">
                        {activeTab === 'orders' && (
                            <div className="animate-in fade-in slide-in-from-right-2 duration-300">
                                <div className="p-4 pb-4 flex items-center justify-between border-b border-slate-50">
                                    <h4 className="text-xs font-semibold text-slate-900 uppercase tracking-widest">Recent Orders</h4>
                                    <div className="flex items-center gap-4">
                                    ...
                                    <table className="w-full text-left">
                                        <thead>
                                            <tr className="bg-slate-50/50 border-b border-slate-50">
                                                <th className="px-4 py-4 text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Order ID</th>
                                                <th className="px-4 py-4 text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Customer</th>
                                                <th className="px-4 py-4 text-[10px] font-semibold text-slate-400 uppercase tracking-widest text-center">Status</th>
                                                <th className="px-4 py-4 text-[10px] font-semibold text-slate-400 uppercase tracking-widest text-right">Amount</th>
                                            </tr>
                                        </thead>
                        ...
                        {activeTab === 'transactions' && (
                            <div className="animate-in fade-in slide-in-from-right-2 duration-300 p-4">
                                <div className="flex items-center justify-between mb-8">
                                    <h4 className="text-sm font-semibold text-slate-900 uppercase tracking-tight">Financial ledger</h4>
                                    <Badge variant="blue" className="text-[9px] font-semibold">LAST 30 DAYS</Badge>
                                </div>
                                    ...
                                    {[
                                        ...
                                        <div key={i} className="flex items-center justify-between p-5 bg-slate-50 rounded-2xl border border-slate-100 group hover:bg-white hover:shadow-md transition-all">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="text-xs font-semibold text-slate-900">{txn.desc}</p>
                                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{txn.id} • {txn.date}</p>
                                                </div>
                                            </div>
                                            <div className="text-right">
                                                <p className={cn("text-sm font-semibold", txn.type === 'credit' ? "text-brand-600" : "text-rose-600")}>
                            ...
                            <div className="animate-in fade-in slide-in-from-right-2 duration-300 h-[500px] relative overflow-hidden group">
                                ...
                                <div className="absolute top-6 left-6 flex flex-col gap-2">
                                    <div className="bg-white/90 backdrop-blur px-4 py-2 rounded-xl shadow-lg border border-white/50">
                                        <p className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Coverage View</p>
                                        <h5 className="text-sm font-semibold text-slate-900">{seller.serviceRadius}km Delivery Area</h5>
                                    </div>
                                </div>
                                <div className="absolute bottom-6 right-6 p-4 max-w-[200px] bg-slate-900/90 backdrop-blur rounded-2xl text-white shadow-2xl border border-white/10">
                                    <p className="text-[9px] font-semibold opacity-60 uppercase mb-1">Live Telemetry</p>
                        ...
                        {activeTab === 'payouts' && (
                            <div className="animate-in fade-in slide-in-from-right-2 duration-300 p-4 text-center py-20">
                                ...
                                <h4 className="text-lg font-semibold text-slate-900 uppercase">Withdrawal tracking</h4>
                                <p className="text-sm font-bold text-slate-400 mt-2 max-w-xs mx-auto">View withdrawal history and pending requests here.</p>
                                <button className="mt-8 px-4 py-3 bg-slate-950 text-white rounded-2xl text-[10px] font-semibold uppercase tracking-widest hover:-translate-y-1 shadow-xl shadow-slate-200 transition-all">
                                    START MANUAL PAYOUT
                                </button>
                            </div>
                        )}
                            ...
                            <div className="animate-in fade-in slide-in-from-right-2 duration-300 p-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-left">
                                    <div className="ds-section-spacing">
                                        <div>
                                            <h5 className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest mb-4">Store Identity</h5>
                                            <div className="space-y-4">
                                                <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                                    ...
                                                    <div>
                                                        <p className="text-xs font-semibold text-slate-900">{seller.shopName}</p>
                                                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{seller.id}</p>
                                                    </div>
                                                </div>
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                                        <p className="text-[9px] font-semibold text-slate-400 uppercase tracking-widest mb-1">Commission</p>
                                                        <p className="text-xs font-semibold text-slate-900">{seller.commissionRate}</p>
                                                    </div>
                                                    <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                                        <p className="text-[9px] font-semibold text-slate-400 uppercase tracking-widest mb-1">Joined</p>
                                                        <p className="text-xs font-semibold text-slate-900">{seller.joinedDate}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <h5 className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest mb-4">Bank Verification</h5>
                                            <div className="p-6 bg-brand-50/50 rounded-xl border border-brand-100 space-y-4">
                                                ...
                                                <div>
                                                    <p className="text-[9px] font-semibold text-brand-700/50 uppercase tracking-widest mb-1">Settlement Account</p>
                                                    <p className="text-sm font-semibold text-slate-900">{seller.bankInfo.bankName}</p>
                                    ...
                                    <div className="ds-section-spacing">
                                        <div>
                                            <h5 className="text-[10px] font-semibold text-slate-400 uppercase tracking-widest mb-4">Operational Status</h5>
                                            <div className="p-6 bg-slate-900 rounded-xl text-white">
                                                <div className="flex items-center justify-between mb-6">
                                                    ...
                                                    <button className="text-[10px] font-semibold text-rose-400 uppercase hover:underline">Force Close</button>
                                                </div>
                                                <div className="space-y-4 opacity-70">
                                                    <div className="flex items-center justify-between py-2 border-b border-white/10">
                                                        <span className="text-xs font-bold">Visibility</span>
                                                        <span className="text-xs font-semibold uppercase tracking-widest">Global</span>
                                                    </div>
                                                    <div className="flex items-center justify-between py-2">
                                                        <span className="text-xs font-bold">Delivery Partner</span>
                                                        <span className="text-xs font-semibold uppercase tracking-widest text-brand-400">Integrated</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="p-6 bg-rose-50 rounded-xl border border-rose-100">
                                            <h5 className="text-[10px] font-semibold text-rose-600 uppercase tracking-widest mb-2 flex items-center gap-2">
                                            ...
                                            <button className="w-full mt-4 py-3 bg-rose-600 text-white rounded-2xl text-[10px] font-semibold uppercase tracking-widest shadow-lg shadow-rose-200 hover:bg-rose-700 transition-all">
                                                SUSPEND STORE
                                            </button>
                                        </div>
                                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <Card className="p-4 border-none shadow-xl ring-1 ring-slate-100 bg-white rounded-xl text-left">
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h4 className="text-lg font-semibold text-slate-900">{seller.ownerName}</h4>
                                <Badge variant="primary" className="text-[8px] font-semibold tracking-[0.2em] px-2">PARTNER</Badge>
                            </div>
                        </div>
                        ...
                        <button className="w-full mt-8 py-3.5 bg-slate-100 hover:bg-slate-200 text-slate-900 rounded-2xl text-[10px] font-semibold uppercase tracking-[0.2em] transition-all">
                            MESSAGE OWNER
                        </button>
                    </Card>
                    ...
                    <Card className="p-4 border-none shadow-xl ring-1 ring-slate-900 bg-slate-900 rounded-xl text-white">
                        ...
                        <div className="space-y-4">
                            ...
                            />
                            <button className="w-full py-4 bg-primary text-primary-foreground rounded-2xl text-[10px] font-semibold uppercase tracking-[0.2em] shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all">
                                SEND ALERT
                            </button>
                        </div>
                    </Card>
