            ...
            <div className="flex">
              {quantity > 0 ? (
                ...
                <button
                  ...
                  className={cn(
                    "bg-white border-[1.5px] border-primary text-primary rounded-lg font-semibold shadow-sm hover:bg-primary/5 mb-0 transition-all uppercase tracking-wide leading-none active:scale-95",
                    compact
